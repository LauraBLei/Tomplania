...
export const NPCList: NPC[] = [
  ...
  {
    type: NPCNames.Frederik,
    name: "Frederik",
    text: {
      startText: [
        "Hello there! You look awesome! Are you new to town? What is your name?!",
        "Well hello {name} my name is Frederik!",
        "I hope i will see you around!",
      ],
      hasVisitedText: ["Hey again {name} !"],
      QuestInProgress: ["Thank you for helping me!"],
      QuestAccepted: ["Oh really?! Thank you!"],
