...
export const LocationList: LocationType = {
  ...
  "Aether Peak": {
    ...
    path: [Locations.WillowbrookLane, Locations.CircleOfTheGods],
  ...
  "Willowbrook Lane": {
    text: "Willowbrook Lane, its such a nice little street..",
    media: {
      src: "./assets/village/willowbrookLane.png",
      alt: "Image of Willowbrook Lane",
    },
    path: [Locations.Eldervale, Locations.PotionShop, Locations.AetherPeak],
    enemy: [],
